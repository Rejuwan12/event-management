...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#5595a79c] text-base-content rounded-b-lg mt-4 ">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-[#5595a79c] text-base-content border-base-300 rounded-b-lg mb-3">
  <aside className="items-center grid-flow-col">
    ...
    <p>Health Fair LTD. <br/>Providing reliable tech since 2023</p>
  </aside> 
